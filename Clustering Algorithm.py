"""
Expt No: 10
Aim: Apply clustering techniques on social media posts using
TF-IDF (Term Frequency-Inverse Document Frequency) and K-Means
to identify customer trends and marketing insights.
"""
